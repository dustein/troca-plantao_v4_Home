...
function App() {
  ...
  return (
    ...
    <Dialog.Root>
      <Dialog.Trigger>
        <button className='text-center flex items-center justify-center border w-min p-3 m-auto border-cyan-700'>Cadastrar</button>
      </Dialog.Trigger>
      <Dialog.Portal>
        ...
        <Dialog.Content className='fixed bg-slate-700 py-8 px-10 text-white top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 rounded-lg w-[480px] shadow-lg shadow-black/25'>
          ...
          <form className='mt-2 flex flex-col gap-2'>
            ...
            <footer className='flex gap-4 justify-end mt-6'>
              ...
              <button type='submit' className='flex gap-2 items-center justify-center border rounded-lg bg-emerald-900 hover:bg-emerald-600 p-1 w-28'>
